  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto rounded-lg responsive-padding mobile-safe-area">
          {!paymentSuccess ? (
            <>
              <DialogHeader className="pb-4">
                <DialogTitle className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent responsive-heading">
                  Enroll in {programTitle}
                </DialogTitle>
                <DialogDescription className="text-gray-600 text-fluid-sm">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-purple-600 hover:bg-purple-700 text-white transition-all duration-300 text-fluid-base mobile-touch-target touch-manipulation"
