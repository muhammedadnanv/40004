      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="relative">
            ...
            />
            <h1 className="relative text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#4A00E0] to-purple-600 drop-shadow-sm">
          ...
          <div className="flex justify-center">
            <Button 
              size="lg" 
              variant="outline" 
              className="text-lg px-8 text-[#4A00E0] border-[#4A00E0] hover:bg-[#4A00E0]/10 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl backdrop-blur-sm"
