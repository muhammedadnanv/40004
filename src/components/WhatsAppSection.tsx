...
export const WhatsAppSection = () => {
  return <section className="py-4 sm:py-6 md:py-8 lg:py-12 xl:py-16 px-3 sm:px-4 md:px-6 lg:px-8 bg-white">
            ...
            <CardContent className="space-y-3 sm:space-y-4 md:space-y-6 p-3 sm:p-4 md:p-6">
              ...
              <div className="flex justify-center pt-1.5 sm:pt-2 md:pt-4">
                ...
                scale: 0.95
                  ...
                  <Button className="bg-[#25D366] hover:bg-[#25D366]/90 gap-1 sm:gap-1.5 md:gap-2 text-[10px] sm:text-xs md:text-sm lg:text-base py-1 sm:py-1.5 md:py-2 lg:py-3 px-2 sm:px-3 md:px-4 shadow-lg hover:shadow-xl transition-all duration-300" onClick={() => window.open("https://chat.whatsapp.com/COaTqrI651TKlYTPrHOYDn", "_blank")}>
